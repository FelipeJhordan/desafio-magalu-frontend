...
export const InputFile = ({ file, setFile }: InputFileProps) => {
...
const HasFile = ({ file, removeFile }: HasFileProps) => {
  return (
    <div className="w-full h-48 rounded-lg border-dashed border-4 border-gray-600 bg-gray-700 flex justify-center items-center">
